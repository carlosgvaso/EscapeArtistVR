    ...
    switch (GvrController.State) {
      case GvrConnectionState.Connected:
		if (dragging) {
			...
			messageText.text = "Well Done!\n\nClick and hold the touchpad to drag the cube.";
		}
		else {
			messageText.text = "Move the controller to move the pointer.\nTry to hover over the pointer over the cube untill it turns yellow.";
		}
